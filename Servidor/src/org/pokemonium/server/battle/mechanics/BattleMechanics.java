...
public abstract class BattleMechanics implements Serializable
{
	 ...
	 */
	abstract public boolean attemptHit(PokemonMove move, Pokemon user, Pokemon target);
	 ...
	 */
	abstract public int calculateDamage(PokemonMove move, Pokemon attacker, Pokemon defender, boolean silent);
	 ...
	 */
	abstract public void validateHiddenStats(Pokemon p) throws ValidationException;
}
