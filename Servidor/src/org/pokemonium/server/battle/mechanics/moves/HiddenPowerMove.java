...
public class HiddenPowerMove extends PokemonMove
{
	...
	public void switchIn(Pokemon source)
	{
		...
		power = (int) (power * 40.0 / 63.0 + 30.0);
		setPower(power);
		type = (int) (type * (15.0 / 63.0));

		PokemonType moveType = new PokemonType[] { PokemonType.T_FIGHTING, PokemonType.T_FLYING, PokemonType.T_POISON, PokemonType.T_GROUND, PokemonType.T_ROCK, PokemonType.T_BUG,
				PokemonType.T_GHOST, PokemonType.T_STEEL, PokemonType.T_FIRE, PokemonType.T_WATER, PokemonType.T_GRASS, PokemonType.T_ELECTRIC, PokemonType.T_PSYCHIC, PokemonType.T_ICE,
				PokemonType.T_DRAGON, PokemonType.T_DARK }[type];
