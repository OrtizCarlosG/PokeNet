...
public class StatMultiplier
{
	 ...
	 */
	private static final double[] m_acc = new double[] { 3.0, 8.0 / 3.0, 7.0 / 3.0, 2.0, 5.0 / 3.0, 4.0 / 3.0, 1.0, 0.75, 0.6, 0.5, 3.0 / 7.0, 3.0 / 8.0, 1.0 / 3.0 };

	/**
	 * Multipliers used for statistics.
	 */
	private static final double[] m_stats = new double[] { 4.0, 3.5, 3.0, 2.5, 2.0, 1.5, 1.0, 2.0 / 3.0, 0.5, 0.4, 1.0 / 3.0, 2.0 / 7.0, 0.25 };
	...
	{
		if(m_position == m_multipliers.length - 1)
			return false;
		++m_position;
		return true;
	}
