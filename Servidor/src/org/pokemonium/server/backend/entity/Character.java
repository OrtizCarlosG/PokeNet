...
public class Character implements Positionable
{
	...
	private boolean m_firstmove = true;
	...
	protected Direction m_lastDirection = Direction.Down;
	
	/* Folling pokemon */
	private int pokemonIDFollow = 0;
	private int m_lastPokemonX, m_lastPokemonY;
	 ...
	 * Get pokemon last X
	 */
	public int getPokemonLastX()
	{
		// Send message pokemon on world
		return m_lastPokemonX;
	}
	
	/**
	 * Get pokemon last Y
	 */
	public int getPokemonLastY()
	{
		// Send message pokemon on world
		return m_lastPokemonY;
	}
	
	/**
	 * Set pokemon id
	 */
	public void reciveFollowPokemonID(int IDFollow)
	{
		// Set message pokemon on world
		pokemonIDFollow = IDFollow;
	}
	
	/**
	 * Send pokemon id
	 */
	public int getFollowPokemonID()
	{
		// Send message pokemon on world
		return pokemonIDFollow;
	}
	...
	/**
	 * Returns the last direction of this car
	 */
	...
	/**
	 * Returns the y last co-ordinate of this char
	 */
	public int getY()
	{
		return m_y;
	...
	/**
	 * Update player pokemons follow
	 */
	public void setUpdatePokemonFollowOverMap()
	{
		// Send to all
		m_map.updatePokemonFollowChar(this);
	}
	 ...
	 * @return
	 */
	public void set_firstmove(boolean m_firstmove) 
	{
		this.m_firstmove = m_firstmove;
	}
}
