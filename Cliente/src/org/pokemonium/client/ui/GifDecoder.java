...
public class GifDecoder {
  ...
  // custom stuff
  public Image getNextFrame() throws IOException, SlickException{
      framePos++;
      if (framePos > frames.size() - 1)
          framePos = 0;
      BufferedImage bi = ((GifFrame)frames.get(framePos)).image;
  ...
  public Image getFirstImage() throws IOException, SlickException{
      BufferedImage bi = ((GifFrame)frames.get(0)).image;
      Texture texture = BufferedImageUtil.getTexture("", bi);
      Image slickImage = new Image(texture.getImageWidth(), texture.getImageHeight() );
      slickImage.setTexture(texture) ;
      return slickImage;
  ...
  public BufferedImage getNextBFrame(){
      framePos++;
      if (framePos > frames.size() - 1)
          framePos = 0;
      BufferedImage bi = ((GifFrame)frames.get(framePos)).image;
  ...
  public BufferedImage getFirstBImage(){
      BufferedImage bi = ((GifFrame)frames.get(0)).image;
      return bi;
  }
