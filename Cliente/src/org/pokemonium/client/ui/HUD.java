...
import org.pokemonium.client.backend.entity.OurPokemon;
import org.pokemonium.client.constants.ServerPacket;
import org.pokemonium.client.protocol.ClientMessage;
import org.pokemonium.client.ui.frames.BattleBag;
import org.pokemonium.client.ui.frames.BattleFrontierDialog;
import org.pokemonium.client.ui.frames.BigBagDialog;
import org.pokemonium.client.ui.frames.BoatChooserDialog;
import org.pokemonium.client.ui.frames.ChatDialog;
import org.pokemonium.client.ui.frames.ClanDialog;
import org.pokemonium.client.ui.frames.FriendsListDialog;
import org.pokemonium.client.ui.frames.HelpWindow;
import org.pokemonium.client.ui.frames.KurtDialog;
import org.pokemonium.client.ui.frames.MoveLearningDialog;
import org.pokemonium.client.ui.frames.MoveRelearnDialog;
import org.pokemonium.client.ui.frames.MoveTutorDialog;
import org.pokemonium.client.ui.frames.OptionsDialog;
import org.pokemonium.client.ui.frames.PartyInfoDialog;
import org.pokemonium.client.ui.frames.PlayerInfoDialog;
import org.pokemonium.client.ui.frames.PlayerPopupDialog;
import org.pokemonium.client.ui.frames.PokeStorageBoxFrame;
import org.pokemonium.client.ui.frames.PokedexDialog;
import org.pokemonium.client.ui.frames.PokemonInfoDialog;
import org.pokemonium.client.ui.frames.RequestDialog;
import org.pokemonium.client.ui.frames.SpriteChooserDialog;
import org.pokemonium.client.ui.frames.TopBar;
import org.pokemonium.client.ui.frames.TownMap;
import org.pokemonium.client.ui.frames.TradeDialog;
import org.pokemonium.client.ui.frames.TrainChooserDialog;
import org.pokemonium.client.ui.frames.battle.BattleDialog;
import org.pokemonium.client.ui.frames.shop.ShopDialog;
import org.pokemonium.client.ui.frames.speechframes.BattleSpeechFrame;
import org.pokemonium.client.ui.frames.speechframes.NPCSpeechFrame;
...
public class HUD extends DesktopArea
{
	...
	public void showClanDialog()
	{
		if(clanDialog.isVisible())
		{
			clanDialog.setVisible(false);
		}
		else
		{
			hideHUDElements();
			clanDialog.setPosition(150, 50);
			clanDialog.setVisible(true);
		}
	}
}
