...
public class ChatDialog extends Widget
{
	...
	private boolean b_showBoadcastMessage = true;
	...
	/**
	 * set to show boadcast message
	 */
	public void setBoadcastFocus(boolean bBoadcast)
	{
		b_showBoadcastMessage = bBoadcast;
	}
