...
public class BattleControlFrame extends Widget
{
	...
	private void initComponents()
	{
		...
		btnPoke.setPosition(390, 10);
		btnPoke.setSize(90, 51);
		...
		attackPane.setSize(600, 201);
		add(attackPane);

		pokePane = new Widget();
		pokePane.setTheme("attackPane");
		pokePane.setSize(457, 201);
