...
public class SpeechFrame extends Widget
{
	...
	public void initGUI()
	{
		...
		{
			setPosition(Math.round(GameClient.getInstance().getGUIPane().getWidth() / 2), Math.round(GameClient.getInstance().getGUIPane().getHeight() / 2 + getWidth() / 2));
		}
	...
	public void layout()
	{
		...
		{
			setSize(502, 78);
			speechDisplay.setSize(502, 100);
			setPosition(Math.round(GameClient.getInstance().getGUIPane().getWidth() / 2 - getWidth() / 8) - 38, Math.round(GameClient.getInstance().getGUIPane().getHeight() / 2 + getWidth() / 2) - 30);
		}
