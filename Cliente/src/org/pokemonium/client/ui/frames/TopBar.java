...
public class TopBar extends Widget
{
	...
	private void initTopbar()
	{
		...
		barbuttons[ 9] = new ImageButton(theme.getImage("topbar_resync"), theme.getImage("topbar_resync_hover"), theme.getImage("topbar_resync_pressed"));
		barbuttons[10] = new ImageButton(theme.getImage("topbar_disconnect"), theme.getImage("topbar_disconnect_hover"), theme.getImage("topbar_disconnect_pressed"));
		
		
		barbuttons[ 0].setTooltipContent("Player stats");
		barbuttons[ 1].setTooltipContent("Pokedex");
		barbuttons[ 2].setTooltipContent("Party");
		barbuttons[ 3].setTooltipContent("Mochila");
		...
		barbuttons[ 9].setTooltipContent("Resynchronize player");
		barbuttons[10].setTooltipContent("Disconnect");
		...
		barbuttons[10].addCallback(new Runnable()
		{
			@Override
			public void run()
			{
		...
		LocationLabel.setTheme("timelabel");
		add(LocationLabel);
	...
	public void layout()
	{
		...
		LocationLabel.setPosition(getInnerX() + getWidth() - (timeLabel.getWidth() * 5), moneyLabel.getInnerY());
	}
}
