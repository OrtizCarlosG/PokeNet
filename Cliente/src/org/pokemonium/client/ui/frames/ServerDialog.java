...
public class ServerDialog extends ResizableFrame
{
	...
	public ServerDialog()
	{
		...
		try
		{
			...
			m_host = new String[5];
			InputStream stream;
			URL url = new URL("http://localhost/pokemon_web/pokemongreeneng/servers.txt");
		...
		catch(IOException ioe)
		{
			...
			ioe.printStackTrace();
			m_host[0] = "http://localhost/pokemon_web/pokemongreeneng/servers.txt";
