...
import org.pokemonium.client.messages.events.*;
...
public class MessageHandler
{
	...
	public void register()
	{
		...
		messages.put(104, new TeleportControllBehavior());
		messages.put(105, new BoadcastMessageStats());
		messages.put(106, new PlayerNewPokemonOutPokeball());
		messages.put(107, new ClanEvent());
	}
}
